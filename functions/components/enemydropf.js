module.exports = function(page, max_pages, data_file) {
    ...
    data_file['drop']['LootTableIndexes'].forEach((each_result) => {
        ...
        let obj = {
            ...
            "description": `${lti_names[each_result['LootTableIndex']].name} [${each_result['LootTableIndex']}]`.substring(0, 50),
            "emoji": {
            ...
            "components": [
                {
                    ...
                    "label": "Previous",
                    "style": 1,
                    "custom_id": "buttons.enemydropf_previous",
                ...
                },
                {
                    ...
                    "label": "Next",
                    "style": 1,
                    "custom_id": "buttons.enemydropf_next",
